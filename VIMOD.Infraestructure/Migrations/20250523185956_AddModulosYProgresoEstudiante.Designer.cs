...
namespace VIMOD.Infraestructure.Migrations
{
    ...
    [Migration("20250523185956_AddModulosYProgresoEstudiante")]
    partial class AddModulosYProgresoEstudiante
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VIMOD.Domain.Models.ContenidoModulo", b =>
                {
            ...
            modelBuilder.Entity("VIMOD.Domain.Models.ModuloCurso", b =>
                {
                    b.Property<int>("IdModulo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VIMOD.Domain.Models.ProgresoEstudiante", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("VIMOD.Domain.Models.Usuario", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VIMOD.Domain.Models.ContenidoModulo", b =>
                {
                    b.HasOne("VIMOD.Domain.Models.ModuloCurso", "ModuloCurso")
                        .WithMany("Contenidos")
            ...
            modelBuilder.Entity("VIMOD.Domain.Models.ProgresoEstudiante", b =>
                {
                    b.HasOne("VIMOD.Domain.Models.ContenidoModulo", "ContenidoModulo")
                        .WithMany()
